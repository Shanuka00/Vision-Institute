...
function Login() {
  return (
    <section className="h-screen mx-40 w-70 space-y-20 mt-20 mb-20 bg-gray-200 rounded-xl p-10">
            ...
            <form>
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="mb-0 mt-2 pt-1 text-sm font-semibold">
                  ...
                  <Nav.Link as={Link} to="/std_registration">
                    <p className="text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700">Register</p>
                  </Nav.Link>
