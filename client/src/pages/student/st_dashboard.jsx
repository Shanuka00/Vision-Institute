...
function DashboardSt() {
  ...
  const [userData] = useState({ firstname: 'Shanuka' });
  const [courses] = useState([
    { id: '1011', subject: 'Science', grade: 'Grade 10', teacher: 'Kasun sir' },
    { id: '1012', subject: 'Mathematics', grade: 'Grade 10', teacher: 'Vijith sir' },
    { id: '1013', subject: 'English', grade: 'Grade 10', teacher: 'Sumedha sir' }
  ]);
  const [notifications] = useState([
    { id: '1', message: 'Grade 10 Science class can be held in A03 classroom on 18.12.2023' },
    { id: '2', message: 'You have attended to Grade 11 Science class on 16.12.2023' }
  ]);
