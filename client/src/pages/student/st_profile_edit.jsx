    ...
    <form className="form-container2" onSubmit={handleSubmit}>
      ...
      <div className="mx-auto w-100 space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="profile-header flex items-center w-full border-b border-gray-900/10 pb-8">
                ...
                <img onClick={handleBackButton} style={{ textDecoration: 'none', cursor: 'pointer' }} className='ml-auto w-12 mb-4 -mt-1' src={backB} alt="Down arrow" />
            </div>
