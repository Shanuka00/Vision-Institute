...
// import sampleQR from '../../images/student/sampleQR.png';
...
//             <img className='bg-indigo-800 p-1 rounded ml-auto mr-auto w-3/4' src={sampleQR} alt="Sample QR" />
//           </div>
...
//                 <button className="bg-indigo-900 hover:bg-indigo-950 text-white font-semibold py-2 px-4 w-10/12 ml-6 mt-8 rounded">
//                   How to create your Vision ID?
//                 </button>
//               </div>
//               <div className="profile-item mb-1">
//                 <button className="bg-indigo-900 hover:bg-indigo-950 text-white font-semibold py-2 px-4 w-10/12 ml-6 mt-8 rounded">
//                   Link to create your Vision ID
//                 </button>
//               </div>
//             </div>
//           </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 mx-16 mt-6 gap-8">
        ...
        <div className="flex flex-col justify-between rounded shadow-md col-span-3 bg-gray-100 p-4 md:p-6">
          ...
          <div className="grid grid-cols-2 w-full ">
            ...
            <div className="profile-right">
              <div className="profile-item mb-1">
                <button className="bg-indigo-900 hover:bg-indigo-950 text-white font-semibold py-2 px-4 w-11/12 ml-3.5 mt-8 rounded">
